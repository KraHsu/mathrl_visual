...
This repository is an unofficial, independent original bilingual interactive
textbook. The ordinary static preview is intended to be buildable and
deployable without an approval workflow.
...
- Chapter teaching text and the 4×4 Grid World implementation in this repository are original work.
...
The repository uses `companion-original` as a compatibility metadata value for
the current preview. Do not infer
...
| Textbook-content license | committed `LICENSE-CONTENT`, attribution and takedown contact | pending |
...
original textbook preview. A technical review, a citation, or a link to a PDF
