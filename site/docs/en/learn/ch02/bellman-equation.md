...
Next, gather the state equations into [matrix form](./matrix-form), or inspect all 16 states in the [shared 4×4 policy-evaluation lab](/en/labs/ch02-policy-evaluation).
