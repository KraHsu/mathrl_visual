...
<style scoped>
.value-function-lab { --lab-accent: #5b4bb7; }.vf-grid { display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:.5rem; max-width:34rem; }.vf-state { min-height:5rem; border:1px solid var(--vp-c-divider); border-radius:.7rem; background:var(--vp-c-bg-soft); color:inherit; text-align:left; padding:.5rem; cursor:pointer; display:flex; flex-direction:column; gap:.2rem; }.vf-state:hover,.vf-state.is-selected { border-color:var(--lab-accent); box-shadow:0 0 0 2px color-mix(in srgb,var(--lab-accent) 20%,transparent); }.vf-state.is-goal { background:color-mix(in srgb,#e5b94e 20%,var(--vp-c-bg-soft)); }.vf-state.is-hazard { background:color-mix(in srgb,#e76f51 14%,var(--vp-c-bg-soft)); }.vf-state span,.vf-state small { color:var(--vp-c-text-2); font-size:.75rem; opacity:1; }.vf-state strong{font-size:1rem}.vf-state small{margin-top:auto;font-size:1.1rem}.vf-layout{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1.25fr);gap:1rem;margin:1rem 0}.inspector-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.75rem}.inspector-grid div{padding:.7rem;background:var(--vp-c-bg-soft);border-radius:.6rem}.inspector-grid span{display:block;font-size:.78rem;opacity:.72}.inspector-grid strong{display:block;margin-top:.3rem;overflow-wrap:anywhere}.feature-vector{font-size:.76rem}.equation-audit{margin:.9rem 0 0;padding:.7rem;background:color-mix(in srgb,var(--lab-accent) 8%,var(--vp-c-bg-soft));border-radius:.5rem;overflow:auto}.equation-audit code{color:var(--vp-c-text-1)}.chart-axis{stroke:var(--vp-c-divider);stroke-width:1}.chart-line{fill:none;stroke:var(--lab-accent);stroke-width:2.5}.chart-dot{fill:var(--lab-accent)}@media(max-width:760px){.vf-layout{grid-template-columns:1fr}.inspector-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
</style>
